...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_categorias values('1', 'Monitor', '1', '24/09/2022)')");
        ...
        db.execSQL("insert into tb_categorias values('4', 'Laptop', '1', '25/09/2022)')");
        db.execSQL("insert into tb_categorias values('5', 'Computadora', '1', '25/09/2022)')");
    }
