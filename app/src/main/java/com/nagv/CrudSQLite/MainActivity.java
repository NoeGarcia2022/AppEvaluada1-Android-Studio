...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String []opciones={"Seleccione una opción:","Monitor", "Celular", "TV", "Laptop", "Computadora"};
        ...
        toolbar.setSubtitleTextColor(getResources().getColor(android.R.color.holo_blue_bright));
        toolbar.setSubtitle("Noe Garcia");
